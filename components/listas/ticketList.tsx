...
import { Action, ListItem, OrderBy, TabItems } from "@/interfaces"
...
const ItemListData: ListItem[] = [
  { id: 123, titulo: "Problema de conexión", subtitulo: "Empresa S.A.", tabId: 1 },
  { id: 124, titulo: "Error al iniciar sesión", subtitulo: "Juan Pérez", tabId: 2 },
  { id: 125, titulo: "Impresora no responde", subtitulo: "María Gómez", tabId: 3 },
  { id: 126, titulo: "Sistema lento", subtitulo: "Tech Corp", tabId: 1 },
  { id: 127, titulo: "Reinicio inesperado del equipo", subtitulo: "Ana López", tabId: 1 },
]
          ...
          </TabsList>
          {
            TabsItemsData.map((i) => (
              <TabsContent value={i.id.toString()}>
                <Listas
                  ItemListData={sortedItems.filter((sort) => (sort.tabId == i.id))}
                  ListIcon={ListIcon}
